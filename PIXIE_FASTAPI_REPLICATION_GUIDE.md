...
- Short. Playful. Natural. Slightly roasty if your personality allows it.
...
class SuggestRequest(BaseModel):
    ...
    persona: PersonaType = "sassy_roast_bestie"
...
async def get_personas():
    return [
        {"id": "sassy_roast_bestie", "name": "Lumi", "label": "Sassy Roast Bestie", "description": "Quick-witted, protective, and sassy", "traits": ["sassy", "playful", "loyal", "protective", "emotionally sharp"]},
        {"id": "smooth_witty_fox", "name": "Lumi", "label": "Smooth Witty Fox", "description": "Clever, relaxed, and street-smart", "traits": ["clever", "witty", "charming", "street-smart", "calm under pressure"]},
        {"id": "elegant_gentleman", "name": "Soren", "label": "Elegant Gentleman", "description": "Measured, polite, and dignified", "traits": ["elegant", "polite", "measured", "dignified", "calm"]},
        {"id": "loyal_bro", "name": "Koda", "label": "Loyal Bro", "description": "Direct, loyal, and no-nonsense", "traits": ["loyal", "direct", "protective", "straightforward", "reliable"]},
        {"id": "soft_social_anxiety_helper", "name": "Mimi", "label": "Soft Social Anxiety Helper", "description": "Soft, warm, and patient", "traits": ["soft", "warm", "patient", "reassuring", "low-pressure"]},
        {"id": "calm_strategist", "name": "Orin", "label": "Calm Strategist", "description": "Calm, concise, and strategic", "traits": ["calm", "rational", "concise", "strategic", "grounded"]},
    ]
